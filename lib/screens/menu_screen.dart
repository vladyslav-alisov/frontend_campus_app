...
import 'package:campus_app/screen_controllers/menu_screens_controllers/menu_controller_screen.dart';
...
class _MenuScreenState extends State<MenuScreenScaffold> {

  final _formKey = GlobalKey<FormState>();

  @override
  void initState() {
    Provider.of<MenuScreenController>(context,listen: false).initVariables();
    super.initState();
  }
                          ...
                          children: [
                            ...
                            DropdownButtonHideUnderline(
                              child: DropdownButton<String>(
                                items: screenController.days.map((String value) {
                        ...
                        if (_formKey.currentState.validate()) {
                          screenController.setIsLoading(true);
                            await CommonController.future(
                                ...
                                "${screenController.dayController} menu has been successfully updated",
                                context);
